    ...
    <div className="plantInfoCard">
      ...
      <div className="nutrientLevels">
        <div className="nutrient">
          <div className="nutrientLevel">
            pH Level : <span className="nutrientValue">{pH}</span>
          </div>
        ...
        <div className="nutrient">
          <div className="nutrientLevel">
            TDS (ppm) Levels : <span className="nutrientValue">{tds} ppm</span>
          </div>
          <div className="progressBar">
            <div
              className="progressFill"
        ...
        <div className="nutrient">
          <div className="nutrientLevel">
            ...
            <span className="nutrientValue">{temperature}°C</span>
          </div>
          <div className="progressBar">
            <div
              className="progressFill"
